...
-- Santos aceita Trasmontano. São Paulo e telemedicina seguem particulares, e
-- por isso ficam com o campo vazio: sem campo, sem pergunta.
update public.clinic_units
set accepts_insurance = 'Trasmontano'
where archived_at is null
  and name ilike '%santos%'
  and accepts_insurance = '';
